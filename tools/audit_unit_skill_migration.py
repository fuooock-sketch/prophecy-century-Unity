...
def fixed_count_acceptance_checks():
    ...
    add("Ger Beast current shop count divisor formula", has_skill_value(ger, "talents", "on_entry_devour_random_shop_gain_stats", ratio=0.1) and has_skill_value(ger, "goldTalents", "on_entry_devour_random_shop_gain_stats", ratio=0.2), "Current shop count divisor formula should import to ratio 0.1/0.2.")
